...
// const positiveNum = Number(prompt("Введите положительное число: "));
// const negativeNum = Number(prompt("Введите отрицательное число: "));

// (positiveNum >= 0 && negativeNum < 0) ? alert("Все значения верны"): alert("Одно или более значений некорректно.");